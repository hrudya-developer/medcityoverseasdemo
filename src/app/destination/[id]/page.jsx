...
export default async function DestinationDetailsPage({
    ...
    const rawUniversities = Array.isArray(
    ...
    const universities = normalizeUniversities(
        rawUniversities
    )
        .filter((university) => {
            ...
            /*
             * Some API responses may omit d_id.
             * Keep those items instead of removing them.
             */
            if (
                universityCountryId === null ||
                universityCountryId === undefined ||
                String(
                    universityCountryId
                ).trim() === ""
            ) {
