...
export default function LoginForm() {
    ...
    return (
        <section
            ...
            className="
        relative flex h-full min-h-[430px] min-w-0
        flex-col overflow-hidden
        bg-[radial-gradient(circle_at_88%_8%,rgba(172,75,238,0.22),transparent_34%),radial-gradient(circle_at_8%_92%,rgba(220,9,84,0.16),transparent_36%),linear-gradient(145deg,#1b102d_0%,#0a0612_100%)]
        px-5 py-6 text-white
        sm:px-7
        lg:min-h-0 lg:px-8 lg:py-7
        xl:px-10
      "
        >
            <div
        ...
        "
            ...
            "
                    ...
                    <span
                        aria-hidden="true"
                        className="
              my-3 block h-[3px] w-11 rounded-full
              bg-gradient-to-r
              from-[#ff1769]
              via-[#e34acb]
              to-[#8c63ff]
              shadow-[0_0_18px_rgba(237,21,93,0.55)]
            "
                    />
              ...
              "
                ...
                "
                  ...
                  bg-[rgba(8,7,22,0.55)]
                  pl-11 pr-4
                  text-[0.88rem] text-white
                  outline-none
                  transition duration-200
                  placeholder:text-white/35
                  hover:border-white/25
                  focus:border-[#ed1b63]
                  focus:bg-[rgba(8,7,22,0.75)]
                  focus:shadow-[0_0_0_4px_rgba(237,27,99,0.12),0_10px_28px_rgba(0,0,0,0.2)]
                ...
                "
                    ...
                    {displayedError ? (
                        <p
                            ...
                            className="
                rounded-lg
                border border-[rgba(255,75,135,0.3)]
                bg-[rgba(187,15,75,0.14)]
                px-3 py-2
                text-[0.76rem] leading-5
                text-[#ffafc6]
              "
                        >
                            {displayedError}
            ...
            "
              ...
              shadow-[0_10px_28px_rgba(203,9,80,0.32)]
              transition duration-200
              hover:-translate-y-0.5
              hover:brightness-110
              hover:shadow-[0_16px_36px_rgba(203,9,80,0.46)]
            ...
            <footer
                className="
          relative z-10 mx-auto mt-4
          flex w-full max-w-[410px]
