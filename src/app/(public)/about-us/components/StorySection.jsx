...
const StoryCard = () => {
    return (
        <article
            className="relative overflow-hidden rounded-[30px] border border-primary/10 bg-white px-6 py-8 shadow-[0_24px_70px_rgba(99,26,51,0.09)] sm:px-8 sm:py-10 lg:px-12 lg:py-12"
        >
            <div
                aria-hidden="true"
            ...
            <div
                className="relative z-10 grid items-center gap-10 lg:grid-cols-[1fr_0.8fr]"
            >
                <div>
                    <div
                        className="inline-flex items-center gap-2 rounded-full border border-primary/15 bg-primary/5 px-4 py-2 text-[11px] font-extrabold uppercase tracking-[0.16em] text-primary"
                    >
                        <Sparkles
                            aria-hidden="true"
                            className="h-4 w-4"
                    ...
                    <p
                        className="mt-6 max-w-4xl text-sm leading-7 text-slate-600 sm:text-base sm:leading-8"
                    >
                        Medcity Study Abroad helps
                        students make informed decisions
                        about international education. We
                        support students in identifying
                        suitable countries, universities
                        and courses based on their
                        academic profile, career goals and
                        personal preferences.
                    </p>

                    <p
                        className="mt-4 max-w-4xl text-sm leading-7 text-slate-600 sm:text-base sm:leading-8"
                    >
                        Our services cover university
                        applications, admission
                        documentation, language
                        preparation, education
                        counselling, student visa
                        assistance and pre-departure
                        guidance. At every stage, our
                        goal is to make the study-abroad
                ...
                <div
                    className="relative overflow-hidden rounded-[26px] border border-primary/10 bg-gradient-to-br from-primary/[0.07] via-white to-secondary/[0.08] p-6 sm:p-8"
                >
                    <div
                        aria-hidden="true"
                    ...
                    <div className="relative z-10">
                        <div
                            className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-darkPrimary text-white shadow-lg shadow-primary/20"
                        >
                            <Plane
                                aria-hidden="true"
                        ...
                        <p
                            className="mt-6 text-xs font-extrabold uppercase tracking-[0.14em] text-secondary"
                        >
                            Student-first approach
                        </p>

                        <h3
                            className="mt-3 text-2xl font-black leading-snug text-[#10204a] sm:text-3xl"
                        >
                            From first counselling to
                            final departure
                        </h3>

                        <p className="mt-4 text-sm leading-7 text-slate-600">
                            We simplify each stage of the
                            journey so students and
                            families can move forward with
        ...
        >
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p
                            className="text-[9px] font-extrabold uppercase tracking-[0.15em] text-secondary/70"
                        >
                            Where we are going
                        </p>
                ...
                <p className="mt-4 text-sm leading-6 text-slate-600">
                    ...
                    student can confidently access
                    reliable guidance, quality education
                    and meaningful global opportunities.
                </p>
        ...
        >
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p
                            className="text-[9px] font-extrabold uppercase tracking-[0.15em] text-primary/70"
                        >
                            What we work toward
                        </p>
                ...
                <p className="mt-4 text-sm leading-6 text-slate-600">
                    To make the study-abroad journey
                    simple, transparent and
                    student-focused through dependable
                    support at every important stage.
                </p>
