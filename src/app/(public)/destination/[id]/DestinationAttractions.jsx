...
export default function DestinationAttractions({
    ...
    return (
        <section
            ...
            className="bg-[#fffafb] py-12 sm:py-14"
        >
            <div
                ...
                >
                    {normalizedAttractions.map(
                        (attraction) => (
                            <article
                                key={attraction.id}
                                className="group rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm transition-all hover:-translate-y-1 hover:border-primary/20 hover:shadow-xl"
                            >
                                <span
                                ...
                                <h3
                                    className="mt-4 text-lg font-black text-darkPrimary"
                                >
                                    {String(
                                        attraction.name
                                    )}
