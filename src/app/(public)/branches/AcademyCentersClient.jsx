...
import BranchesFAQ from "./components/BranchesFAQ";
  ...
  return (
    <>
      <section
        ...
        className="relative isolate mx-auto mb-10 w-full overflow-hidden bg-gradient-to-b from-white via-[#fffafd] to-white scroll-mt-28"
      >
