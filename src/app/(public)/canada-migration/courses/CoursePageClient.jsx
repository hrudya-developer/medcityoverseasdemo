...
function HeroVisual() {
    return (
        ...
        >
            <div
                className="relative mx-auto flex min-h-[370px] items-center justify-center overflow-visible sm:min-h-[470px] lg:min-h-[530px]"
            >
                {/* Soft blue background glow */}
                <div
                    aria-hidden="true"
                    className="absolute left-1/2 top-1/2 size-[290px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-secondary/10 blur-[55px] sm:size-[410px] lg:size-[490px]"
                />

                {/* Secondary light-blue circle */}
                <div
                    aria-hidden="true"
                    className="absolute left-1/2 top-1/2 size-[260px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#eaf6ff] sm:size-[370px] lg:size-[450px]"
                />

                {/* Blue dotted pattern */}
                <div
                    aria-hidden="true"
                    className="absolute right-[2%] top-[7%] size-24 opacity-45 [background-image:radial-gradient(#0466AF_1.5px,transparent_1.5px)] [background-size:12px_12px] sm:size-32 lg:size-36"
                />

                {/* Pink dotted pattern */}
                <div
                    aria-hidden="true"
                    className="absolute bottom-[5%] left-[5%] size-20 opacity-35 [background-image:radial-gradient(#c01f53_1.5px,transparent_1.5px)] [background-size:12px_12px] sm:size-28"
                />

                {/* Yellow decorative circle */}
                <div
                    aria-hidden="true"
                    className="absolute bottom-[9%] right-[4%] size-16 rounded-full bg-logoYellow/80 shadow-[0_15px_35px_rgba(247,236,34,0.25)] sm:size-24 lg:size-28"
                />

                {/* Blue decorative ring */}
                <div
                    aria-hidden="true"
                    className="absolute left-[4%] top-[17%] size-14 rounded-full border-[5px] border-secondary/20 sm:size-20 lg:size-24"
                />

                {/* Blue rounded block */}
                <div
                    aria-hidden="true"
                    className="absolute left-[12%] bottom-[13%] size-12 rotate-12 rounded-2xl bg-secondary/15 sm:size-16"
                />

                {/* Small primary circle */}
                <div
                    aria-hidden="true"
                    className="absolute right-[13%] top-[31%] size-5 rounded-full bg-primary/30 sm:size-7"
                />

                {/* Small blue circle */}
                <div
                    aria-hidden="true"
                    className="absolute right-[20%] bottom-[20%] size-6 rounded-full bg-secondary/25 sm:size-8"
                />

                {/* Plus decorations */}
                <span
                    aria-hidden="true"
                    className="absolute left-[15%] top-[38%] select-none text-3xl font-black text-primary/20 sm:text-4xl"
                >
                    +
                </span>
                ...
                <span
                    aria-hidden="true"
                    className="absolute right-[15%] top-[17%] select-none text-3xl font-black text-secondary/25 sm:text-4xl"
                >
                    +
                </span>
                ...
                {/* Circular image */}
                <div
                    className="relative z-10 size-[275px] overflow-hidden rounded-full border-[4px] border-white bg-white shadow-[0_28px_70px_rgba(15,23,42,0.17)] sm:size-[385px] sm:border-[5px] lg:size-[460px] xl:size-[490px]"
                >
                    <div
                        aria-hidden="true"
                        className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.8),transparent_72%)]"
                    />
                ...
                {/* Destination card */}
                <div
                    className="absolute right-0 top-[8%] z-20 rounded-2xl border border-white/15 bg-secondary px-4 py-3 text-white shadow-[0_18px_42px_rgba(192,31,83,0.32)] sm:right-[1%] sm:px-5 sm:py-4 lg:right-0"
                >
                    ...
                    <p
                        className="mt-1 text-[10px] font-bold text-white/80 sm:text-xs"
                    >
                        Study destinations
                    </p>
                </div>
                ...
                {/* Students card */}
                <div
                    className="absolute bottom-[7%] left-0 z-20 rounded-2xl border border-white/15 bg-darkPrimary px-4 py-3 text-white shadow-[0_18px_42px_rgba(192,31,83,0.32)] sm:left-[1%] sm:px-5 sm:py-4 lg:left-0"
                >
                    ...
                    <p
                        className="mt-1 text-[10px] font-semibold text-white/80 sm:text-xs"
                    >
                        guided worldwide
                    </p>
                </div>
