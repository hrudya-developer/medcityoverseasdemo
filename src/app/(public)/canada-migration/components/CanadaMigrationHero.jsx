...
function HeroContent() {
    return (
        ...
        >
            ...
            >
                Discover Canadian permanent residence,
                Express Entry, provincial programs, work
                permits, family sponsorship and business
            ...
            <div
                ...
                aria-label="Canada migration benefits"
            >
                {highlights.map(
                    ({ icon: Icon }, index) => (
                        <div
                            key={index}
                            className="group relative grid size-12 place-items-center rounded-2xl border border-primary/10 bg-primary text-white shadow-[0_10px_24px_rgba(15,23,42,0.07)] transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:bg-primary hover:text-white hover:shadow-[0_15px_32px_rgba(192,31,83,0.22)] sm:size-14"
                        >
                            <Icon
                                size={20}
                                strokeWidth={2}
            ...
            >
                ...
                >
                    ...
                    <Image
                        ...
                        alt="Canada migration, permanent residence and career opportunities"
                        fill
                        priority
                        sizes="
