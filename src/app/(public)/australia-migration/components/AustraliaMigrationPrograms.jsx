...
export default function AustraliaMigrationPrograms() {
    return (
        <section
            ...
            className="relative scroll-mt-24 overflow-hidden bg-gradient-to-b from-white via-[#fffafb] to-[#f4f9ff] px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20"
        >
            <SectionBackground />
            ...
            >
                ...
                <div
                    className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-3 lg:gap-5 xl:gap-7"
                >
                ...
                <div className="mt-12 text-center">
                    <Link
                        href="/contact-us"
                        className="group inline-flex min-h-13 items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-darkPrimary to-primary px-7 text-sm font-black text-white shadow-[0_16px_38px_rgba(192,31,83,0.25)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_22px_48px_rgba(192,31,83,0.34)]"
                    >
    ...
    return (
        ...
        >
            ...
            >
                <span
                    aria-hidden="true"
                    className="grid size-12 place-content-center rounded-2xl bg-gradient-to-br from-primary to-darkPrimary text-white shadow-[0_12px_28px_rgba(192,31,83,0.25)]"
                >
                    <Network size={23} />
                </span>
                ...
                <h2
                    ...
                    className="text-3xl font-black tracking-[-0.04em] text-darkPrimary sm:text-4xl lg:text-[44px]"
                >
            ...
            >
                ...
                <span
                    className="size-2 rounded-full bg-primary ring-4 ring-primary/10"
                />
...
function PathwayColumn({
    ...
    return (
        <article
            ...
            className="group/column relative flex h-full min-w-0 flex-col overflow-hidden rounded-[28px] border border-slate-200/80 bg-white/90 p-4 shadow-[0_16px_45px_rgba(15,23,42,0.07)] backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_26px_65px_rgba(15,23,42,0.12)] sm:p-5 xl:p-6"
        >
            <div
                aria-hidden="true"
                className={cn(`
            ...
            <header
                className="relative z-10 rounded-[22px] border border-slate-100 bg-white p-4 shadow-[0_10px_30px_rgba(15,23,42,0.07)] sm:p-5"
            >
                <div
                ...
                >
                    ...
                    <div className="min-w-0">
                        ...
                        <h3
                            ...
                            className="mt-2 text-lg font-black leading-6 text-darkPrimary sm:text-xl"
                        >
                            {pathway.title}
                        </h3>
                    </div>
            ...
            <p
                className="relative z-10 mt-5 min-h-[72px] text-xs leading-6 text-slate-600 sm:text-sm"
            >
                {pathway.description}
            </p>
            ...
            <div
                aria-hidden="true"
                className="pointer-events-none absolute bottom-0 left-1/2 h-1 w-0 -translate-x-1/2 rounded-full bg-gradient-to-r from-secondary via-primary to-darkPrimary transition-all duration-500 group-hover/column:w-3/4"
            />
...
function PathwayOption({
    ...
    return (
        ...
        >
            <div
                aria-hidden="true"
                className="absolute -right-10 -top-10 size-24 rounded-full bg-slate-100/60 transition-transform duration-500 group-hover/card:scale-150"
            />
                ...
                <div className="min-w-0 flex-1">
                    ...
                    >
                        <div className="min-w-0">
                            ...
                            <h4
                                className="mt-1 text-xs font-bold leading-5 text-slate-700"
                            >
                                {option.title}
                            </h4>
                        </div>
                        ...
                        <span
                            aria-hidden="true"
                            className="grid size-7 shrink-0 place-content-center rounded-full border border-slate-200 bg-slate-50 text-slate-400 transition-all duration-300 group-hover/card:border-primary/20 group-hover/card:text-primary"
                        >
                            <ArrowUpRight
                                size={12}
                            />
                    ...
                    <p
                        className="mt-3 text-[11px] leading-5 text-slate-500 sm:text-xs"
                    >
                        {option.description}
                    </p>
...
function SectionBackground() {
    return (
        ...
        >
            <div
                className="absolute inset-0 opacity-[0.2] [background-image:linear-gradient(rgba(99,26,51,0.055)_1px,transparent_1px),linear-gradient(90deg,rgba(99,26,51,0.055)_1px,transparent_1px)] [background-size:34px_34px] [mask-image:linear-gradient(to_bottom,transparent,black_15%,black_85%,transparent)]"
            />

            <div
                className="absolute -left-28 top-20 size-80 rounded-full bg-primary/[0.07] blur-3xl"
            />

            <div
                className="absolute -right-28 bottom-10 size-80 rounded-full bg-secondary/[0.07] blur-3xl"
            />

            <div
                className="absolute left-1/2 top-0 h-44 w-44 -translate-x-1/2 rounded-full bg-logoYellow/[0.07] blur-3xl"
            />
        </div>
    );
}