...
const highlights = [
    {
        icon: BadgeCheck,
        label:
            "Skilled permanent visa pathways",
    },
    {
        icon: BriefcaseBusiness,
        label:
            "Career and employer sponsorship",
    },
    {
        icon: MapPinned,
        label:
...
const imageHighlights = [
    ...
    "Regional and Employer Pathways",
];

export default function AustraliaMigrationHero() {
    return (
        <section
            aria-labelledby="australia-migration-heading"
...
function HeroContent() {
    return (
        <div
            className="relative z-20 mx-auto w-full max-w-[680px] text-center lg:mx-0 lg:text-left"
        >
            <div
                className="inline-flex items-center gap-2 rounded-full border border-primary/15 bg-white/85 px-4 py-2 text-[10px] font-black uppercase tracking-[0.16em] text-primary shadow-[0_8px_25px_rgba(99,26,51,0.08)] backdrop-blur-xl sm:text-xs"
            >
                <Sparkles
                    size={14}
                    aria-hidden="true"
                ...
                Live. Work. Build Your Future.
            </div>

            <h1
                id="australia-migration-heading"
                className="mt-5 text-3xl font-extrabold leading-[1.07] tracking-[-0.045em] text-[#0c1b35] sm:text-4xl lg:text-5xl xl:text-5xl"
            >
                Explore Your Path to{" "}
                <span
                    className="relative inline-block text-darkPrimary"
                >
                    Australia
            ...
            <p
                className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base sm:leading-8 lg:mx-0 lg:text-lg"
            >
                Discover skilled independent,
                state-nominated, regional and
                employer-sponsored pathways for
                living and working in Australia.
            </p>

            <div
                aria-label="Australia migration benefits"
            ...
            >
                {highlights.map(
                    ({
                        ...
                        <div
                            key={label}
                            className="group relative grid size-12 place-items-center rounded-2xl border border-primary/10 bg-primary text-white shadow-[0_10px_24px_rgba(15,23,42,0.07)] transition-all duration-300 hover:-translate-y-1 hover:bg-darkPrimary hover:shadow-[0_15px_32px_rgba(192,31,83,0.22)] sm:size-14"
                        >
                            <Icon
                                size={20}
                                strokeWidth={2}
            ...
            >
                <a
                    href="#australia-migration-programs"
                    className="group inline-flex min-h-13 items-center justify-center gap-3 rounded-2xl bg-darkPrimary px-6 text-sm font-black text-white shadow-[0_15px_35px_rgba(99,26,51,0.25)] transition-all duration-300 hover:-translate-y-1 hover:bg-primary hover:shadow-[0_20px_42px_rgba(192,31,83,0.3)]"
                >
                    Explore Programs
                ...
                <a
                    href="#australia-migration-steps"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Image
                        src="/assets/australia-migration.png"
                        alt="Australia migration, skilled work and permanent residence opportunities"
                        fill
                        priority
                        sizes="
