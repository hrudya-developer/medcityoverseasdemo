          ...
          >
              <div className="mx-auto max-w-3xl text-center">
                  ...
                  <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
                      Find the right pathway based on your
                      education, qualifications, career goals,
                      and interests.
                  </p>
              </div>
                  ...
                  programs.length > 0 ? (
                      ...
                      <div className="rounded-3xl border border-slate-200 bg-white p-10 text-center shadow-sm">
                          <h3 className="text-xl font-bold text-darkPrimary">
                              German programs are currently
                              unavailable
                          </h3>

                          <p className="mt-2 text-slate-600">
                              Please check back later for
                              available study and career
