...
export default function GermanProgramCard({
  ...
  return (
    <Link
      href={detailsHref}
      className="group flex h-full min-h-[520px] flex-col overflow-hidden rounded-[30px] border border-slate-100 bg-white shadow-[0_16px_45px_rgba(15,23,42,0.10)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_28px_65px_rgba(99,26,51,0.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
    >
      <article
      ...
      >
        ...
        <div className="relative block h-56 overflow-hidden bg-slate-100 sm:h-64">
          {mainImage ? (
            <img
              itemProp="image"
              src={mainImage}
        ...
        <div className="flex flex-1 flex-col p-6">
          ...
          <div className="mt-auto inline-flex w-fit items-center gap-2 pt-6 text-sm font-bold text-primary">
            Explore Program
            <ArrowRight
              aria-hidden="true"
              size={17}
