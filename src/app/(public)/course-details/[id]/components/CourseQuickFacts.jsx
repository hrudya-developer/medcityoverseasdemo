...
export default function CourseQuickFacts({
    ...
    return (
        <section
            className="relative mx-5 -mt-10 rounded-2xl border border-slate-100 bg-white shadow-xl lg:mx-auto lg:max-w-6xl"
        >
            <div
                className="grid grid-cols-1 divide-y divide-slate-200 md:grid-cols-3 md:divide-x md:divide-y-0"
            >
                {items.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="min-w-0">
                                ...
                                <p
                                    className="mt-1 break-words text-sm font-bold text-slate-950"
                                >
                                    {values[item.key]}
                                </p>
