                        ...
                        (mainCourse, index) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(`group relative flex min-w-[220px] shrink-0 items-center gap-4 overflow-hidden rounded-2xl border px-4 py-4 text-left transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${isActive
                                ...
                                >
                                    <span
                                        aria-hidden="true"
                                        className={cn(`pointer-events-none absolute -right-8 -top-8 size-24 rounded-full blur-2xl ${isActive
                                                ? "bg-white/15"
                                                : "bg-primary/10"
                                            }`)}
                                    />
                                    ...
                                    <span
                                        aria-hidden="true"
                                        className={cn(`relative grid size-12 shrink-0 place-items-center rounded-2xl border transition duration-300 ${isActive
                                    ...
                                    <span className="relative min-w-0 flex-1">
                                        ...
                                        <span
                                            className={cn(`mt-1.5 inline-flex items-center rounded-full px-2.5 py-1 text-xs font-bold ${isActive
