...
function InfoLine({
    ...
    return (
        <div
            className={`group/info flex items-start gap-3 rounded-2xl border border-slate-100 bg-[#f8f9fc] transition duration-300 hover:border-primary/15 hover:bg-primary/[0.035] ${compact ? "p-3.5" : "p-4"
                }`}
        >
