    ...
    return (
        <article
            ...
            className="
                ...
                bg-white p-4
                shadow-[0_14px_42px_rgba(126,34,206,0.08)]
                transition-all duration-500
                hover:-translate-y-1.5
                hover:border-purple-300
                hover:shadow-[0_26px_65px_rgba(126,34,206,0.14)]
                sm:p-5
                lg:p-6
            "
        >
                        ...
                        ({
                            ...
                            <article
                                ...
                                className="
                                    ...
                                    hover:-translate-y-1
                                    hover:border-purple-300
                                    hover:shadow-[0_14px_30px_rgba(126,34,206,0.11)]
                                "
                            >
                                <div
                                    aria-hidden="true"
                                ...
                                >
                                    <span
                                        ...
                                        className="
                                            ...
                                            text-purple-700
                                            transition-all duration-300
                                            group-hover/card:bg-purple-600
