...
function WorkCard({
    ...
    return (
        ...
        ease-out
        hover:-translate-y-2
        hover:shadow-[0_24px_55px_rgba(15,23,42,0.15)]
        sm:p-8
        lg:max-w-none
      "
        >
...
function CardBackground({
    ...
    return (
        ...
        "
          ...
          inset-0
          opacity-[0.08]
          [background-image:radial-gradient(circle,rgba(15,23,42,0.28)_1px,transparent_1px)]
          [background-size:18px_18px]
          [mask-image:linear-gradient(to_bottom_right,black,transparent_75%)]
        "
            />
        </>
    );
