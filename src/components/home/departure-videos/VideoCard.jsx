...
const VideoCard = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Static poster: no preview video */}
        <img
          src={video.poster}
          alt={`${
            video.title ||
        ...
        <span className="pointer-events-none absolute right-3 top-3 rounded-full border border-white/25 bg-black/50 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-white">
          Video
        </span>
      </button>
    </article>
