...
const EssentialServices = () => {
    return (
        <section
            ...
            className="relative isolate overflow-hidden bg-[url('/assets/students-essential-services.webp')] bg-cover bg-center bg-no-repeat bg-fixed px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24"
        >
            {/* Dark background overlay */}
            <div
                aria-hidden="true"
                className="absolute inset-0 -z-10 bg-gradient-to-b from-black/90 via-black/85 to-[#160810]/95"
            />

            {/* Pink glow */}
            <div
                aria-hidden="true"
                className="absolute -left-40 top-1/3 -z-10 h-[420px] w-[420px] rounded-full bg-primary/15 blur-[120px]"
            />

            {/* Blue glow */}
            <div
                aria-hidden="true"
                className="absolute -right-40 bottom-0 -z-10 h-[400px] w-[400px] rounded-full bg-secondary/15 blur-[120px]"
            />
