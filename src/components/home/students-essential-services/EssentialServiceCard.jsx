...
const ContactCard = ({
    ...
    return (
        <article
            className="
        group relative flex h-full min-h-[350px]
        flex-col overflow-hidden rounded-[30px]
        border border-black/10
        bg-white p-7 text-black
        shadow-[0_25px_70px_rgba(247,236,34,0.25)]
        transition-all duration-500
        hover:-translate-y-2
        hover:shadow-[0_35px_90px_rgba(247,236,34,0.4)]
      "
        >
        ...
        "
            ...
            "
              ...
              border border-black
              bg-black px-5 py-4
              text-sm font-bold text-logoYellow
              ...
              focus-visible:ring-offset-logoYellow
            "
                    >
                        <span
                            aria-hidden="true"
      ...
      "
        ...
        "
            ...
            <div className="relative z-10 flex h-full flex-col">
              ...
              shadow-[0_10px_30px_rgba(192,31,83,0.15)]
              transition-all duration-500
              group-hover:rotate-3
              group-hover:scale-110
              group-hover:border-primary
              group-hover:bg-primary
              group-hover:shadow-[0_15px_35px_rgba(192,31,83,0.35)]
            "
                    >
                        <Icon
                            aria-hidden="true"
