...
export default function GermanCoursesLayout() {
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className="grid items-center gap-10 lg:grid-cols-[0.85fr_1.65fr]"
                >
                    <div
                        className="text-center lg:text-left"
                    >
                        <span
                            className="inline-flex rounded-full border border-pink-200 bg-white px-4 py-2 text-xs font-bold uppercase tracking-widest text-primary shadow-sm"
                        >
                            Study. Work. Settle
                            in Germany
                        </span>
                        ...
                        <h1
                            ...
                            className="mt-5 font-nunito text-3xl font-extrabold leading-tight text-darkPrimary sm:text-4xl lg:text-5xl"
                        >
                            German{" "}
                            <span className="lg:block">
                                Popular{" "}
                                <span
                                    className="bg-gradient-to-r from-primary via-[#a83d8b] to-secondary bg-clip-text text-transparent"
                                >
                                    Courses
                                </span>
                            </span>
                        ...
                        <p
                            className="mx-auto mt-5 max-w-md text-sm leading-7 text-slate-600 sm:text-base lg:mx-0"
                        >
                            Discover leading
                            German study and
                            career pathways for
                    ...
                    <div className="min-w-0">
                        ...
                        {!programsLoading &&
                            ...
                            0 && (
                                <p
                                    className="rounded-2xl border border-dashed border-slate-300 bg-white px-5 py-10 text-center text-slate-500"
                                >
                                    No German
                                    programs found.
                                </p>
...
function BackgroundDecorations() {
    return (
        <>
            <div
                aria-hidden="true"
                className="pointer-events-none absolute -left-28 top-12 h-72 w-72 rounded-full bg-pink-200/40 blur-3xl"
            />

            <div
                aria-hidden="true"
                className="pointer-events-none absolute -right-28 bottom-8 h-72 w-72 rounded-full bg-blue-200/40 blur-3xl"
            />

            <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-0 opacity-[0.22] [background-image:radial-gradient(circle_at_1px_1px,rgba(99,26,51,0.12)_1px,transparent_0)] [background-size:24px_24px]"
            />
        </>
    );
}